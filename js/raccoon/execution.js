Object.assign(window.Raccoon, {
    ...
    async executeStack(startBlockId, spriteId, useSnapshot = false) {
        ...
        while(currentBlockId && !checkIfStopping()) {
            ...
            try {
                ...
                const errorMsg = `Execution error in block ${block.id} (${block.type}): ${e.message}`;
    ...
    start() {
        this.log("▶️ Execution Started (Flag Clicked)", "system");
    ...
    stopAllScripts() {
        this.log("⏹️ Execution Stopped", "system");
