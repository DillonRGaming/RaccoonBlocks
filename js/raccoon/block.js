Object.assign(window.Raccoon, {
    ...
    duplicateStack(startBlockId, mousePos, returnRootId = false, startDragging = false) { 
        ...
        this.log(`Duplicating stack from block: ${originalBlock.type} (${originalBlock.id})`);
    ...
    deleteStack(startBlockId, spriteId) {
        ...
        this.log(`Deleting stack from block: ${startBlock.type} (${startBlock.id})`, 'action');
    ...
    switchBlock(blockId, newBlockType) {
        ...
        this.log(`Switching block ${oldBlock.type} to ${newBlockType}`, 'action');
